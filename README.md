...
## Learning Objectives
- Understand how to replicate a cool Double landing page application which can be adopted for different applications.

## Description of the Project
For the first milestone in the process of creating Double landing page application, you will:
